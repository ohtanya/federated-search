...
QueryBuilder.DEFAULTS = {
    ...
    icons: {
        ...
        add_rule:     'fa fa-plus',
        remove_group: 'dx dx-remove',
        remove_rule:  'dx dx-remove',
...
<dl id="{{= it.group_id }}" class="rules-group-container"> \
  <dt class="rules-group-header"> \
    <div class="pull-right group-actions"> \
      ...
      {{?}} \
      {{? it.level>1 }} \
        <button type="button" class="btn btn-link" data-delete="group"> \
...
<li id="{{= it.rule_id }}" class="rule-container"> \
  <div class="rule-header"> \
    <div class="btn-group pull-right rule-actions"> \
      <button type="button" class="btn btn-link" data-delete="rule"> \
            ...
            case 'checkbox':
                Utils.iterateOptions(filter.values, function(key, val) {
                  ...
                  //   </div>
                    ...
                    h += '<div class="checkbox-inline"><label>' + c + '<input type="' + filter.input + '" name="' + name + '" value="' + key + '"> ' + val + '<span></span></label></div> ';
                });
                break;
 ...
 * @param {string} [options.style='btn-default']
